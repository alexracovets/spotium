    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          // Для constrainToMain позиціонуємо між header і footer
          constrainToMain &&
            (side === 'left' || side === 'right') &&
            'top-[var(--header-height,0px)] bottom-[var(--footer-height,0px)] h-[calc(100vh-var(--header-height,0px)-var(--footer-height,0px))]',
          !constrainToMain && (side === 'right' || side === 'left') && 'inset-y-0 h-full',
          className,
        )}
        {...props}
      >
